  ...
  return texto
    ...
    .replace(
      ...
      (_, label, url) => {
        ...
        return `<a href="${url}" ${isExternal ? 'target="_blank" rel="noopener noreferrer"' : ''} style="color:#a78bfa;text-decoration:underline;text-decoration-color:rgba(167,139,250,0.4)">${label}</a>`
      }
    )
}
